                ...
                <div className="flex relative dark:bg-main-dark-bg">
                    <div className="fixed bottom-4 right-4" style={{ zIndex: '1000' }}>
                        <TooltipComponent content='Settings' position='Top'>
                            <button type='button' className='text-3xl hover:drop-shadow-xl hover:bg-light-gray p-3 text-white' style={{ background: 'blue', borderRadius: '50%' }}>
                                <FiSettings />
                            </button>
                        </TooltipComponent>
                    </div>
                    ...
                    <div className={`w-full dark:bg-main-bg bg-main-bg min-h-screen ${activeMenu ? 'md:ml-72' : 'flex-2'}`}>
